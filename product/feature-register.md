...
|---|---|---|---|---|---|---|
| NC-CONTEXT | Negotiation Context Memory — kontinuierliche Extraktion + Tool-Sync | Feature | In Delivery | negotiation-buddy | R-2026-09 | Brief: product/briefs/NC-CONTEXT.md. Phase A implementiert 1b2977a: extractInputs vom Throttle entkoppelt, max 5 Versuche, HTTP-Fehler kein Attempt-Verbrauch, Regex-Fallback für Gegenseite-Zahlen. Phase B bereits implementiert (ZopaCalculator). Phase C (Guided Flow) → FEATURE-GUIDED-CONTEXT. |
