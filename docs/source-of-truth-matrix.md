...
| Business Logic Owner | Railway `sessionRoutes.ts` — 50-message limit enforced atomically via BEFORE INSERT trigger `trg_session_history_message_limit` (RFB-004-C `243c02d` 2026-04-16) + app-layer count check for defence-in-depth |
