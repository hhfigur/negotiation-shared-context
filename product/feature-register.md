...
| NC-TELEMETRY | Telemetrie-Setup — Konversions- und Nutzungsdaten | Feature | Released | negotiationcoach-backend, negotiation-buddy | R-2026-08 | Brief: product/briefs/NC-TELEMETRY.md. Released 2026-04-30. 4 Events instrumentiert. Kein Capture-Layer — Baselines UNKNOWN bis NC-TELEMETRY-C. |
| NC-TELEMETRY-C | Telemetrie Capture-Layer — PostHog / Sentry / Custom | Enabler | Proposed | negotiation-buddy, shared-context | TBD | Abhängig von NC-TELEMETRY (Released). Entscheidung ob + welches Analytics-Tool. Migration von console.log auf Aggregations-Layer. Blocking: metrics.md Baselines bleiben UNKNOWN. Brief: muss erstellt werden. |
