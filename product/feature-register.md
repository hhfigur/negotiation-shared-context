...
|---|---|---|---|---|---|---|
| NC-NAV | Navigation & Tier-Struktur Redesign — Gastmodus entfernen, subscription_tier als Gate, Profi-Sidebar, Mobile Bottom Tab Bar | Feature | In Delivery | negotiation-buddy (primary), shared-context (docs) | TBD (R-2026-10) | Brief: product/briefs/NC-NAV.md. 5 Phasen: A–E. **Phase A — ✅ DONE `847aa79`** (2026-06-22): isGuest entfernt, subscription_tier-Gate, OnboardingDialog entfernt, tsc clean. **Phase B — ✅ DONE `237aee7`** (2026-06-22): Team-Link in Sidebar für Profi. **Phase C — ✅ DONE `ff03384`** (2026-06-22): Mobile BottomTabBar (Chat/Tools/Profil), BottomBar md:hidden, tsc clean. **Phase D — ✅ DONE `faf5975`** (2026-06-22): /profile Abo-Status, Dev-Tier-Mock, Account-Sektion, kritischer subscription_tier="free"-Bug gefixt. Phase E offen. |
