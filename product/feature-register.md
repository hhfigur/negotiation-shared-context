...
|---|---|---|---|---|---|---|
| NC-NAV | Navigation & Tier-Struktur Redesign — Gastmodus entfernen, subscription_tier als Gate, Profi-Sidebar, Mobile Bottom Tab Bar | Feature | In Delivery | negotiation-buddy (primary), shared-context (docs) | TBD (R-2026-10) | Brief: product/briefs/NC-NAV.md. 5 Phasen: A (Auth-Gate + Tier-Gating), B (Profi Sidebar), C (Mobile BottomTabBar), D (/profile Überarbeitung), E (Landing Demo). Phase A in Delivery. |
