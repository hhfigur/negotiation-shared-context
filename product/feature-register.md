...
|---|---|---|---|---|---|---|
| NC-NAV | Navigation & Tier-Struktur Redesign — Gastmodus entfernen, subscription_tier als Gate, Profi-Sidebar, Mobile Bottom Tab Bar | Feature | In Delivery | negotiation-buddy (primary), shared-context (docs) | TBD (R-2026-10) | Brief: product/briefs/NC-NAV.md. 5 Phasen: A–E. **Phase A — ✅ DONE `847aa79`** (2026-06-22): isGuest entfernt, subscription_tier-Gate, OnboardingDialog entfernt, tsc clean. **Phase B — ✅ DONE `237aee7`** (2026-06-22): Team-Link in Sidebar für Profi. Phasen C–E offen. |
